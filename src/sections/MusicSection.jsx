...
import musicDrawn from '../assets/music-drawn.webp'
import courtyardWhite from '../assets/courtyard-white.webp'
import courtyardText from '../assets/courtyard-text.webp'
...
export default function MusicSection({ active }) {
  const { theme } = useTheme()
  const isDark = theme === 'dark'
  const logoSrc = isDark ? courtyardWhite : courtyardText
  const logoDims = isDark ? { w: 900, h: 214 } : { w: 900, h: 216 }
    ...
    <section className={`page-section${active ? ' active' : ''}`} id="section-music">
      <div className="content">
        ...
        <div className="music-hero">
          <div className="music-logo-wrap">
            <img
              className="courtyard-img"
              src={logoSrc}
              width={logoDims.w}
              height={logoDims.h}
              style={{ filter: 'none' }}
            ...
            <p className="music-desc">
              Rochester-based band formed at RIT, performing originals with pop, jazz, and funk
              influences. Check out our debut album on your favorite streaming platform!
            </p>
            ...
            <p className="max-klot-wordmark" aria-label="Max Klot">
              <span className="max" id="max">MAX</span>
              <span id="klot" className="max">KLOT</span>
            </p>

            <p className="music-desc">
              I also make music as a solo artist. During the pandemic, I taught myself how to
